...
│   │   │   └── [DATASET_NAME]_classification_map.png (if generated by main.py)
│   │   ├── sweep_[SWEEP_TYPE]_[TIMESTAMP]/ # Outputs for a sweep run
│   │   │   └── ...
│   │   └── classification_maps/ # Dedicated folder for maps from generate_classification_maps.py
│   │       └── maprun_[TIMESTAMP]/
│   │           ├── [DATASET_NAME]_classification_map.png
│   │           └── [DATASET_NAME]_map_run_config.json
│   └── classification_map_generation/ # Logs for the map generation script
│       └── map_generation_log_[TIMESTAMP].txt
│
├── scripts/                  # Executable scripts
│   ├── main.py
│   ├── sweep_bands.py
│   ├── sweep_bands_efdpc.py
│   ├── sweep_combinations.py
│   ├── sweep_combinations_botswana.py
│   ├── sweep_combinations_pu.py
│   ├── generate_classification_maps.py
